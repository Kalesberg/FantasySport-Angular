...
import {FilterService, GraphTabs, GraphTabConstants} from "../../../services/filter.service";
...
export class GraphComponent implements OnInit {
  ...
  constructor(private router:Router, private activatdRoute:ActivatedRoute, private filterService:FilterService) {
  ...
  getData(tabName, filters:FilterCriteria[] = null) {
    this.isLoading = true;
    this.filterService.retrieveGraphData(tabName, filters)
      .subscribe(
        data => {
